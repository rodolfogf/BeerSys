...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-09-26 20:34:26',NULL),('diagnostics.include_raw','OFF','2020-09-26 20:34:26',NULL),('ps_thread_trx_info.max_length','65535','2020-09-26 20:34:26',NULL),('statement_performance_analyzer.limit','100','2020-09-26 20:34:26',NULL),('statement_performance_analyzer.view',NULL,'2020-09-26 20:34:26',NULL),('statement_truncate_len','64','2020-09-26 20:34:26',NULL);
...
-- Dump completed on 2020-10-05 17:04:06
-- MySQL dump 10.13  Distrib 8.0.21, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: beersys
-- ------------------------------------------------------
-- Server version	8.0.21
...
INSERT INTO `brand` VALUES (1,'Brahma'),(2,'Skol');
...
CREATE TABLE `client_registry` (
  ...
  `adress_street` varchar(60) DEFAULT NULL,
  `adress_number` int DEFAULT NULL,
  `adress_zip_code` int DEFAULT NULL,
  `adress_state` varchar(2) DEFAULT NULL,
  `adress_adjunct` varchar(20) DEFAULT NULL,
...
INSERT INTO `family` VALUES (1,'Ale'),(2,'Lager');
...
INSERT INTO `label` VALUES (1,'Brahma Chop',1,1),(2,'Brahma extra weiss',1,2),(3,'Brahma wess special',1,2),(4,'Skol Puro Malte',2,1);
...
CREATE TABLE `product` (
  ...
  `vessel_indice` varchar(30) DEFAULT NULL,
  `price` double DEFAULT NULL,
  `volume` double DEFAULT NULL,
  `bulk_sale` tinyint(1) DEFAULT NULL,
...
INSERT INTO `product` VALUES (1,4,'0',0,355,1),(2,1,'lata',5,200,1),(3,3,'garrafa',20,290,0);
...
CREATE TABLE `sale_item` (
  `id_sale_item` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `style` VALUES (1,'Pilsen',2),(2,'weiss',1);
...
INSERT INTO `user` VALUES (1,'jose','123',1),(2,'maria','123',0),(3,'rodolfo','123',1),(4,'sidney','123',1);
